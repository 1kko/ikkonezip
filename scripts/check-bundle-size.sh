...
# Raw size budgets. Gzip ratio for this bundle is ~3.5x, so 800 KB raw is
# ~230 KB over the wire. Bumped 525→800 KB after the folder-tree view
# (FileTreeNode + buildFileTree) pushed the main chunk past 525 KB; future
# bundle reductions (e.g. lazy-load via React.lazy) can lower this back.
JS_BUDGET=819200   # 800 KB
